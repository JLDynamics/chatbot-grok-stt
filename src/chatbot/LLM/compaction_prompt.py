...
compatible with :meth:`~chatbot.LLM.chat.Chat.trim_if_needed`.
...
from chatbot.LLM.chat import CompactFn, CompactionResult
...
def build_compactor(generate_fn: CompactGenerateFn) -> CompactFn:
    ...
    *generate_fn* is the only model-specific dependency: it receives
    ...
    Both :class:`~chatbot.LLM.openai_api_language_model.OpenApiModelHandler`
    and :class:`~chatbot.LLM.language_model.BaseLanguageModelHandler`
