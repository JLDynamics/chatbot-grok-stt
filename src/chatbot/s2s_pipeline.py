...
from chatbot.arguments_classes.realtime_server_arguments import (
...
def parse_arguments(
    ...
    *,
    ...
    if _is_json:
        ...
        _pre = argparse.ArgumentParser(prog=f"chatbot {command}", add_help=False)
    ...
    parser = HfArgumentParser(tuple(argument_classes), prog=f"chatbot {command}")  # type: ignore[arg-type]
