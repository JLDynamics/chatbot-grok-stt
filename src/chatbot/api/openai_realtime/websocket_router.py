...
from chatbot.api.openai_realtime.llm_proxy import LLMProxyConfig, mount_llm_proxy
...
try:
    ...
    from chatbot.api.openai_realtime.webrtc_session import (
        WebRTCSession,
...
def create_app(
    ...
    async def webrtc_calls_endpoint(request: Request) -> Response:
        ...
        if not WEBRTC_AVAILABLE:
            return Response(
                content="WebRTC support requires the 'webrtc' extra: pip install 'chatbot[webrtc]'",
                status_code=501,
